...
# text->Vector
# 生成VECTORPATH
mahout seq2sparse -i $TEXTPATH -o $VECTORPATH -ow -wt tfidf -lnorm -nv -a org.wltea.analyzer.lucene.IKAnalyzer --maxDFPercent 95 --namedVector

# Run K-Means
# mahout kmeans -i $VECTORPATH/tfidf-vectors -k 10 -c /home/user1/cluster/bbs-kmeans-clusters -o $CLUSTERPATH  -dm org.apache.mahout.common.distance.CosineDistanceMeasure -x 1000 --convergenceDelta 0.05 -ow --clustering
# Run Fuzzy-K-Means
mahout fkmeans -i $VECTORPATH/tfidf-vectors -k 10 -c bbs-kmeans-clusters -o $CLUSTERPATH -dm org.apache.mahout.common.distance.CosineDistanceMeasure -m 1.05 -x 1500 -ow --clustering --convergenceDelta 0.001
...
awk -F '\t' 'NR==FNR{a[$1]=$2;} NR>FNR{print "no_topic""\t"$0"\t"a[$1]}' /home/user1/cluster/res_file /home/user1/cluster/res_clusters >/home/user1/cluster/data
